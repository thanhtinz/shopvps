  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: #f9fafb; padding: 40px; border-radius: 0 0 8px 8px;">
        ...
        <p style="color: #6b7280;">Xin chào <strong>${name}</strong>,</p>
        <p style="color: #6b7280;">Nhấn vào nút bên dưới để xác thực email và kích hoạt tài khoản.</p>
        ...
        <p style="color: #9ca3af; font-size: 12px;">Link có hiệu lực trong 24 giờ. Nếu bạn không yêu cầu, hãy bỏ qua email này.</p>
      </div>
    </div>
  `;
}
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: #f9fafb; padding: 40px; border-radius: 0 0 8px 8px;">
        ...
        <p style="color: #6b7280;">Xin chào <strong>${name}</strong>,</p>
        <p style="color: #6b7280;">Nhấn vào nút bên dưới để đặt lại mật khẩu của bạn.</p>
        <div style="text-align: center; margin: 32px 0;">
        ...
        <p style="color: #9ca3af; font-size: 12px;">Link có hiệu lực trong 1 giờ. Nếu bạn không yêu cầu, hãy bỏ qua email này.</p>
      </div>
    </div>
  `;
}
