...
export default function KbArticlePage() {
  ...
  if (notFound) return <div style={{ maxWidth:760, margin:"0 auto", textAlign:"center", padding:"60px 20px", color:"var(--text-muted)" }}>Không tìm thấy bài viết. <Link href="/kb" style={{ color:"var(--accent)" }}>← Về Kiến thức</Link></div>;

  return (
    <div style={{ maxWidth:760, margin:"0 auto" }}>
      <Link href="/kb" style={{ display:"inline-flex", alignItems:"center", gap:6, fontSize:13, color:"var(--text-muted)", textDecoration:"none", marginBottom:16 }}>← Kiến thức</Link>
      ...
      <div style={{ fontSize:12, color:"var(--text-muted)", marginBottom:24 }}>{article.views} lượt xem</div>
