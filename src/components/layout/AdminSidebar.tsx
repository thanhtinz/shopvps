...
const nav = [
  ...
  { section: "Tài chính", items: [
    { href:"/admin/invoices", label:"Hoá đơn", icon:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8" },
    ...
    { href:"/admin/tax-rules", label:"Quy tắc thuế", icon:"M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z M9 22V12h6v10 M9 8h6" },
  ...
  { section: "Sản phẩm & Dịch vụ", items: [
